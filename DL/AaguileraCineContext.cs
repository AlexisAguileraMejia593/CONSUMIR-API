...
public partial class AaguileraCineContext : DbContext
{
    public AaguileraCineContext()
    {
    }

    public AaguileraCineContext(DbContextOptions<AaguileraCineContext> options)
        : base(options)
    {
    }
